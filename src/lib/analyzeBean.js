...
For process: look everywhere on the label including inside the product name line. Look for words like "washed", "natural", "honey", "anaerobic", "double anaerobic", "wet", "dry", "pulped", "carbonic maceration", "lavado", "naturel", "miel", "水洗", "日晒", "蜜处理", "厭氧" (anaerobic in Traditional Chinese), "雙重厭氧" (double anaerobic), "嫌気性", "ナチュラル", "ウォッシュド", "워시드", "내추럴", "허니". Map to the closest English name (e.g. "水洗" → "Washed Process", "日晒" → "Natural Process", "厭氧" → "Anaerobic", "雙重厭氧" → "Double Anaerobic"). If the bag only states a country/farm with no process mentioned, return null.
