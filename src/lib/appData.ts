...
export const PHASES: PhasesMap = {
  'V60': [
    { name: 'Bloom Pour', icon: 'water_drop', targetWater: 50, duration: 15, instruction: 'Pour in a slow spiral from the centre outward. Aim for 2–3× the dose weight and ensure every ground is saturated.' },
    { name: 'Bloom Rest', icon: 'hourglass_top', targetWater: 50, duration: 45, instruction: 'Set the kettle down and wait. Vigorous CO₂ bubbling is a sign of fresh coffee — let the bed fully degas before the next pour.' },
    { name: 'First Pour', icon: 'water_drop', targetWater: 150, duration: 45, instruction: 'Pour in steady concentric circles, never breaking the surface. Maintain a thin, even stream for uniform extraction.' },
    { name: 'Second Pour', icon: 'water_drop', targetWater: 250, duration: 45, instruction: 'Complete the pour with slow, deliberate spirals from centre outward. Keep the stream low and gentle to avoid agitation.' },
    { name: 'Draw Down', icon: 'hourglass_bottom', targetWater: 0, duration: 75, instruction: 'Let the brew drain completely undisturbed. A flat, evenly coloured bed at the end indicates a balanced extraction.' },
  ],
  'Chemex': [
    { name: 'Bloom Pour', icon: 'water_drop', targetWater: 70, duration: 20, instruction: 'Pre-wet the filter with hot water, then discard it. Pour the bloom water slowly in a spiral to saturate all grounds evenly.' },
    { name: 'Bloom Rest', icon: 'hourglass_top', targetWater: 70, duration: 45, instruction: 'Wait for the crust to rise and CO₂ to escape. This extended degas is key to Chemex clarity — do not rush it.' },
    { name: 'First Pour', icon: 'water_drop', targetWater: 220, duration: 60, instruction: 'Pour slowly in a steady spiral. The thick Chemex filter demands patience — a slow, controlled pour prevents bypass and channelling.' },
    { name: 'Final Pour', icon: 'water_drop', targetWater: 430, duration: 60, instruction: 'Add the remaining water with a gentle, high pour. This increases turbulence for a brighter, cleaner finish in the cup.' },
    { name: 'Draw Down', icon: 'hourglass_bottom', targetWater: 0, duration: 120, instruction: 'Allow the full draw down without interference. Never squeeze or press the filter — it will introduce fines and cloudiness.' },
  ],
  'AeroPress': [
    { name: 'Bloom & Stir', icon: 'water_drop', targetWater: 50, duration: 15, instruction: 'Add the bloom water and stir vigorously 5 times to fully saturate all grounds. This kickstarts even extraction.' },
    { name: 'Bloom Rest', icon: 'hourglass_top', targetWater: 50, duration: 30, instruction: 'Wait 30 seconds for the grounds to bloom. You should see the surface swell as CO₂ releases.' },
    { name: 'Fill', icon: 'water_drop', targetWater: 200, duration: 20, instruction: 'Pour the remaining water in a steady stream. The AeroPress is forgiving — aim for an even fill with no dry pockets.' },
    { name: 'Steep', icon: 'coffee', targetWater: 0, duration: 60, instruction: 'Place the cap and let it steep. For lighter roasts, extend to 90 seconds. For espresso-style, press immediately after filling.' },
    { name: 'Press', icon: 'compress', targetWater: 0, duration: 30, instruction: 'Apply slow, steady pressure — around 500g of force. Stop when you hear the hiss; pressing the puck dry adds bitterness.' },
  ],
  'French Press': [
    { name: 'Bloom Pour', icon: 'water_drop', targetWater: 70, duration: 15, instruction: 'Add the bloom water and give a gentle stir to ensure all grounds are saturated. This pre-infusion improves evenness.' },
    { name: 'Bloom Rest', icon: 'hourglass_top', targetWater: 70, duration: 30, instruction: 'Wait for the grounds to degas. A small crust forming on top is normal and a sign of fresh coffee.' },
    { name: 'Fill', icon: 'water_drop', targetWater: 500, duration: 60, instruction: 'Pour the remaining water steadily. Place the lid on top with the plunger fully raised — do not press yet.' },
    { name: 'Steep', icon: 'hourglass_bottom', targetWater: 0, duration: 240, instruction: 'Allow 4 full minutes of undisturbed steeping. Stirring during this phase accelerates over-extraction — resist the urge.' },
    { name: 'Press & Pour', icon: 'compress', targetWater: 0, duration: 30, instruction: 'Press the plunger down slowly with gentle, even force. Pour into your cup immediately to halt extraction.' },
  ],
}
